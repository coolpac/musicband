...
export const residents: Resident[] = [
  ...
  },
  {
    ...
    description:
      'Мультиинструменталист, продюсер, звукоинженер. С 8 лет в музыке. Начинал со струнных инструментов. Имеет 5 авторских музыкальных проектов. «Йоу».',
  ...
  },
  {
    ...
    description:
      'Занимался вместе с Александром карате. Один из лучших преподавателей города по игре на гитаре. 20 лет не выпускал ее из рук. Имеет особенное видение и вкус в музыке. «Я за то, чтобы мы слушали живую, настоящую музыку»',
